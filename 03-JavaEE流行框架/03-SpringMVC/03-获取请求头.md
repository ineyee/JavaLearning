...
###### 4.1 方式一：使用 @RequestHeader 注解获取所有请求头
...
###### 4.2 方式二：使用 @RequestHeader 注解获取特定请求头
...
###### 4.3 方式三：使用之前的 HttpServletRequest req 参数获取所有请求头
...
###### 4.4 方式四：使用之前的 HttpServletRequest req 参数获取特定请求头
