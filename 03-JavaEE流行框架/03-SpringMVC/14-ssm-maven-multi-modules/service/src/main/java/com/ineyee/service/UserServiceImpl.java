...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public List<User> listPageHelper(Integer pageSize, Integer pageNum) {
    ...
    @Override
    public List<Integer> saveBatch(List<User> userList) {
        int ret = userDao.saveBatch(userList);
        return ret > 0 ? userList.stream().map(User::getId).toList() : new ArrayList<>();
    }
