...
/*
	...
	2、对象数据类型 <==> 引用类型
		* 实际开发中，在使用对象的时候要写大量的判空来增加代码的健壮性，因为对 null 使用属性和方法都会崩溃
		* Java 里所有的引用类型最终都继承自基类 Object，别的语言里写 Any、dynamic 的、Java里写 Object 就行
...
/*
	...
	* getClass() 方法只可以应用于对象数据类型的变量，返回一个类，可以直接与类字面量（如 String.class）比较。在实例方法里我们可以通过“对象.getClass()”获取到当前对象所属的类，在类方法里我们可以通过“类.class”获取到当前类
